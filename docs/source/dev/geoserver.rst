...
We strongly encourage that you create a ``Workspace``. For more information on Workspaces and the data structure of GeoServer, refer to the official `GeoServer Online Documentation <https://docs.geoserver.org/stable/en/user/data/webadmin/workspaces.html>`_.
...
For more information on the Data Adding process from the GeoServer Administration Panel, see the `GeoServer documentation <https://docs.geoserver.org/stable/en/user/gettingstarted/shapefile-quickstart/index.html>`_.
...
.. note::
    ...
    You must have a working installation of QGIS (2.14.x, 2.18.x) and access to the QGIS Plugin Manager. QGIS is multi-OS and available at `QGIS.org <https://qgis.org/>`_.
